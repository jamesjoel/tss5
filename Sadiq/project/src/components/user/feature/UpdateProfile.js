                                ...
                                <thead>
                                    {
                                        pageData.map((value)=>{
                                            return(
                                                <tr>
                                                    <th>{value.name}</th>
                                                    <td><input type={value.name === "Date of Birth" ? 'date' : 'text'} onChange={updateProfile.handleChange} name={value.name === "Date of Birth" ? 'dob' : value.name.toLowerCase()} placeholder={`Enter Your ${value.name}`} value={value.data} className={'form-control'} /></td>
                                                </tr>
                                            )
                                        })
                                    }
